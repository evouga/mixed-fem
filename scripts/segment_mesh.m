...
[V,T,F]=readMESH("../models/mesh/gummy_bear/gummy_bear_2.mesh");
F = boundary_faces(T);
%tsurf(F,V,'FaceAlpha',0.5);
%axis equal;
[V1,F1] = readOBJ("../models/mesh/gummy_bear/gummy_bear_brain.obj");
%hold on;
...
ids(I<0) = 1;
writeDMAT('gummy_bear_2_material_ids.dmat',ids);