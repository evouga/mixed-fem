...
template<>
IntegratorFactory<STORAGE_EIGEN>::IntegratorFactory() {
...
template class mfem::IntegratorFactory<STORAGE_EIGEN>;
template class mfem::IntegratorFactory<STORAGE_THRUST>;
