...
{
  // Copy!
  double V0[3] = {A0(0),A0(1),A0(2)};
  double V1[3] = {A1(0),A1(1),A1(2)};
  double V2[3] = {A2(0),A2(1),A2(2)};
  double U0[3] = {B0(0),B0(1),B0(2)};
  double U1[3] = {B1(0),B1(1),B1(2)};
  double U2[3] = {B2(0),B2(1),B2(2)};
  return 1==NoDivTriTriIsect( V0,V1,V2,U0,U1,U2);
}
