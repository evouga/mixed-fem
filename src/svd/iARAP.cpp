...
void iARAP::ComputeEigenvector0(double a00, double a01, double a02, double a11,
...
void iARAP::ComputeOrthogonalComplement(Eigen::Vector3d const &W,
...
void iARAP::ComputeEigenvector1(double a00, double a01, double a02, double a11,
...
double iARAP::trace_S(const Eigen::Matrix3d &F)
{
...
Matrix3d iARAP::rotation(const Matrix3d &F) {
  Matrix<double, 9, 9> dRdF;
  return rotation(F, false, dRdF);
}

Matrix3d iARAP::rotation(const Matrix3d &F, bool compute_gradients,
    Matrix<double, 9, 9>& dRdF) {
